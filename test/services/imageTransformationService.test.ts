...
import { transformImage, getBestImageFormat, shouldUseResponsiveSizing } from '../../src/services/imageTransformationService';
...
describe('ImageTransformationService', () => {
  ...
  describe('transformImage', () => {
    it('should create and execute a command', async () => {
      ...
      const { TransformImageCommand } = await import('../../src/domain/commands/TransformImageCommand');
      ...
      const mockCommand = (TransformImageCommand as any).mock.results[0].value;
    ...
    it('should handle errors and rethrow them', async () => {
      ...
      const { TransformImageCommand } = await import('../../src/domain/commands/TransformImageCommand');
      (TransformImageCommand as any).mockImplementationOnce(() => ({
