...
describe('CacheManagementService', () => {
  ...
  beforeEach(() => {
    ...
    // Reset cache mocks
    (caches.default.match as CacheMock['match']).mockReset();
    (caches.default.put as CacheMock['put']).mockReset();
  });

  describe('getCachedResponse', () => {
    it('should return cached response when available', async () => {
      // Arrange
      (caches.default.match as CacheMock['match']).mockResolvedValue(mockResponse);
    ...
    it('should return null when no cached response is found', async () => {
      // Arrange
      (caches.default.match as CacheMock['match']).mockResolvedValue(null);
    ...
    it('should handle errors gracefully', async () => {
      // Arrange
      (caches.default.match as CacheMock['match']).mockRejectedValue(new Error('Cache error'));
  ...
  describe('cacheResponse', () => {
    it('should store response in cache if cacheable', async () => {
      // Arrange
      (caches.default.put as CacheMock['put']).mockResolvedValue(undefined);
    ...
    it('should handle errors gracefully', async () => {
      // Arrange
      (caches.default.put as CacheMock['put']).mockRejectedValue(new Error('Cache error'));
