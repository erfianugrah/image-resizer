...
async function fetchR2Object(bucket: MockR2Bucket, key: string, transformOptions?: Record<string, string>): Promise<Response> {
  ...
  if (object.customMetadata) {
    Object.entries(object.customMetadata).forEach(([key, value]) => {
      if (key !== 'cache-control') { // cache-control already added
