...
import { ConfigurationManager, createConfigManager } from '../../src/config/configManager';
...
describe('ConfigManager implementation', () => {
  describe('Factory-based ConfigManager', () => {
    beforeEach(() => {
      // Reset all mocks
      vi.resetAllMocks();
    });
    ...
    describe('createConfigManager', () => {
      it('should create a config manager instance', () => {
        const configManager = createConfigManager({ logger: mockLogger });
        expect(configManager).toBeDefined();
        expect(configManager.getConfig).toBeDefined();
        expect(configManager.initialize).toBeDefined();
      });
    });
    ...
    describe('initialize', () => {
      it('should initialize the configuration with defaults when env variables are empty', () => {
        ...
        // Act
        configManager.initialize(emptyEnv);
  ...
  describe('Legacy Singleton ConfigurationManager', () => {
